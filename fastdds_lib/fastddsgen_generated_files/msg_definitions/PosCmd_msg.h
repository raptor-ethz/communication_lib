...
#ifndef _IDL_MSG_POSCMD_MSG_H_
#define _IDL_MSG_POSCMD_MSG_H_
...
#if defined(_WIN32)
#if defined(EPROSIMA_USER_DLL_EXPORT)
#if defined(PosCmd_msg_SOURCE)
#define PosCmd_msg_DllAPI __declspec( dllexport )
#else
#define PosCmd_msg_DllAPI __declspec( dllimport )
#endif // PosCmd_msg_SOURCE
#else
#define PosCmd_msg_DllAPI
#endif  // EPROSIMA_USER_DLL_EXPORT
#else
#define PosCmd_msg_DllAPI
#endif // _WIN32
...
namespace idl_msg {
    /*!
     * @brief This class represents the structure PosCmd_msg defined by the user in the IDL file.
     * @ingroup POSCMD_MSG
     */
    class PosCmd_msg
    {
    public:
         ...
         */
        eProsima_user_DllExport PosCmd_msg();
         ...
         * @param x Reference to the object idl_msg::PosCmd_msg that will be copied.
         */
        eProsima_user_DllExport PosCmd_msg(
                const PosCmd_msg& x);
         ...
         * @param x Reference to the object idl_msg::PosCmd_msg that will be copied.
         */
        eProsima_user_DllExport PosCmd_msg& operator =(
                const PosCmd_msg& x);
         ...
         * @param x idl_msg::PosCmd_msg object to compare.
         */
