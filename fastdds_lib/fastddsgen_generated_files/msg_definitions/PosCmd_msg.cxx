...
idl_msg::PosCmd_msg::PosCmd_msg()
{
    ...
    // m_yaw_angle com.eprosima.idl.parser.typecode.PrimitiveTypeCode@588df31b
    m_yaw_angle = 0.0;
...
idl_msg::PosCmd_msg& idl_msg::PosCmd_msg::operator =(
        const PosCmd_msg& x)
{
...
bool idl_msg::PosCmd_msg::operator ==(
        const PosCmd_msg& x)
{
...
size_t idl_msg::PosCmd_msg::getMaxCdrSerializedSize(
...
size_t idl_msg::PosCmd_msg::getCdrSerializedSize(
        const idl_msg::PosCmd_msg& data,
        size_t current_alignment)
{
    (void)data;
    size_t initial_alignment = current_alignment;
...
void idl_msg::PosCmd_msg::serialize(
...
void idl_msg::PosCmd_msg::deserialize(
 ...
 */
void idl_msg::PosCmd_msg::header(
 ...
 */
const idl_msg::Header_msg& idl_msg::PosCmd_msg::header() const
{
    return m_header;
}
 ...
 */
idl_msg::Header_msg& idl_msg::PosCmd_msg::header()
{
    return m_header;
}
/*!
 ...
 */
void idl_msg::PosCmd_msg::position(
 ...
 */
const idl_msg::Position_msg& idl_msg::PosCmd_msg::position() const
{
    return m_position;
}
 ...
 */
idl_msg::Position_msg& idl_msg::PosCmd_msg::position()
{
    return m_position;
}
/*!
 ...
 */
void idl_msg::PosCmd_msg::yaw_angle(
        float _yaw_angle)
{
 ...
 */
float idl_msg::PosCmd_msg::yaw_angle() const
{
    return m_yaw_angle;
}
 ...
 */
float& idl_msg::PosCmd_msg::yaw_angle()
{
    return m_yaw_angle;
}


size_t idl_msg::PosCmd_msg::getKeyMaxCdrSerializedSize(
        size_t current_alignment)
{
...
bool idl_msg::PosCmd_msg::isKeyDefined()
{
    return false;
}

void idl_msg::PosCmd_msg::serializeKey(
        eprosima::fastcdr::Cdr& scdr) const
{
    (void) scdr;
