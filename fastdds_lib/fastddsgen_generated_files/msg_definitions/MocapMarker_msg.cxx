...
{
    // m_header com.eprosima.idl.parser.typecode.StringTypeCode@6107227e
    m_header ="";
    // m_length com.eprosima.idl.parser.typecode.PrimitiveTypeCode@7c417213
    m_length = 0;
    // m_occluded com.eprosima.idl.parser.typecode.ArrayTypeCode@15761df8
    memset(&m_occluded, 0, (10) * 1);
    // m_marker_x com.eprosima.idl.parser.typecode.ArrayTypeCode@6ab7a896
    memset(&m_marker_x, 0, (10) * 4);
    // m_marker_y com.eprosima.idl.parser.typecode.ArrayTypeCode@327b636c
    memset(&m_marker_y, 0, (10) * 4);
    // m_marker_z com.eprosima.idl.parser.typecode.ArrayTypeCode@45dd4eda
