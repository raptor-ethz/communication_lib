...
/*!
 * @file Vector3f_msgPubSubTypes.cpp
...
#include "Vector3f_msgPubSubTypes.h"
...
bool Vector3f_msgPubSubType::serialize(void *data,
...
bool Vector3f_msgPubSubType::deserialize(SerializedPayload_t *payload,
                                         void *data) {
...
Vector3f_msgPubSubType::getSerializedSizeProvider(void *data) {
  return [data]() -> uint32_t {
    return static_cast<uint32_t>(
               type::getCdrSerializedSize(*static_cast<Vector3f_msg *>(data))) +
           4u /*encapsulation*/;
  };
}
...
void Vector3f_msgPubSubType::deleteData(void *data) {
  delete (reinterpret_cast<Vector3f_msg *>(data));
}

bool Vector3f_msgPubSubType::getKey(void *data, InstanceHandle_t *handle,
                                    bool force_md5) {
