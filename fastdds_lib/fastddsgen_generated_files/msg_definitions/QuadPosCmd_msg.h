...
/*!
 * @file QuadPosCmd_msg.h
 * This header file contains the declaration of the described types in the IDL file.
 *
 * This file was generated by the tool gen.
 */

#ifndef _IDL_MSG_QUADPOSCMD_MSG_H_
#define _IDL_MSG_QUADPOSCMD_MSG_H_
...
#if defined(_WIN32)
#if defined(EPROSIMA_USER_DLL_EXPORT)
#if defined(QuadPosCmd_msg_SOURCE)
#define QuadPosCmd_msg_DllAPI __declspec( dllexport )
#else
#define QuadPosCmd_msg_DllAPI __declspec( dllimport )
#endif // QuadPosCmd_msg_SOURCE
#else
#define QuadPosCmd_msg_DllAPI
#endif  // EPROSIMA_USER_DLL_EXPORT
#else
#define QuadPosCmd_msg_DllAPI
#endif // _WIN32
...
namespace idl_msg {
    /*!
     * @brief This class represents the structure QuadPosCmd_msg defined by the user in the IDL file.
     * @ingroup QUADPOSCMD_MSG
     */
    class QuadPosCmd_msg
    {
    public:
         ...
         */
        eProsima_user_DllExport QuadPosCmd_msg();
         ...
         * @param x Reference to the object idl_msg::QuadPosCmd_msg that will be copied.
         */
        eProsima_user_DllExport QuadPosCmd_msg(
         ...
         * @param x Reference to the object idl_msg::QuadPosCmd_msg that will be copied.
         */
        eProsima_user_DllExport QuadPosCmd_msg& operator =(
                const QuadPosCmd_msg& x);
         ...
         * @param x idl_msg::QuadPosCmd_msg object to compare.
         */
...
#endif // _IDL_MSG_QUADPOSCMD_MSG_H_