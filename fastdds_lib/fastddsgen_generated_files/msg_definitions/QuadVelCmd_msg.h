...
/*!
 * @file QuadVelCmd_msg.h
 * This header file contains the declaration of the described types in the IDL file.
 *
 * This file was generated by the tool gen.
 */

#ifndef _IDL_MSG_QUADVELCMD_MSG_H_
#define _IDL_MSG_QUADVELCMD_MSG_H_
...
#if defined(_WIN32)
#if defined(EPROSIMA_USER_DLL_EXPORT)
#if defined(QuadVelCmd_msg_SOURCE)
#define QuadVelCmd_msg_DllAPI __declspec( dllexport )
#else
#define QuadVelCmd_msg_DllAPI __declspec( dllimport )
#endif // QuadVelCmd_msg_SOURCE
#else
#define QuadVelCmd_msg_DllAPI
#endif  // EPROSIMA_USER_DLL_EXPORT
#else
#define QuadVelCmd_msg_DllAPI
#endif // _WIN32
...
namespace idl_msg {
    /*!
     * @brief This class represents the structure QuadVelCmd_msg defined by the user in the IDL file.
     * @ingroup QUADVELCMD_MSG
     */
    class QuadVelCmd_msg
    {
    public:
         ...
         */
        eProsima_user_DllExport QuadVelCmd_msg();
         ...
         * @param x Reference to the object idl_msg::QuadVelCmd_msg that will be copied.
         */
        eProsima_user_DllExport QuadVelCmd_msg(
         ...
         * @param x Reference to the object idl_msg::QuadVelCmd_msg that will be copied.
         */
        eProsima_user_DllExport QuadVelCmd_msg& operator =(
                const QuadVelCmd_msg& x);
         ...
         * @param x idl_msg::QuadVelCmd_msg object to compare.
         */
         ...
         */
        eProsima_user_DllExport const idl_msg::Vector3f_msg& velocity() const;

        /*!
         * @brief This function returns a reference to member velocity
         * @return Reference to member velocity
         */
        eProsima_user_DllExport idl_msg::Vector3f_msg& velocity();
        /*!
    ...
    private:
        ...
        idl_msg::Vector3f_msg m_velocity;
        float m_yaw_rate;
    };
} // namespace idl_msg

#endif // _IDL_MSG_QUADVELCMD_MSG_H_