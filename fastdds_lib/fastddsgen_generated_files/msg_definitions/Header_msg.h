...
#ifndef _IDL_MSG_HEADER_MSG_H_
#define _IDL_MSG_HEADER_MSG_H_
...
#if defined(_WIN32)
#if defined(EPROSIMA_USER_DLL_EXPORT)
#if defined(Header_msg_SOURCE)
#define Header_msg_DllAPI __declspec( dllexport )
#else
#define Header_msg_DllAPI __declspec( dllimport )
#endif // Header_msg_SOURCE
#else
#define Header_msg_DllAPI
#endif  // EPROSIMA_USER_DLL_EXPORT
#else
#define Header_msg_DllAPI
#endif // _WIN32
...
namespace idl_msg {
    /*!
     * @brief This class represents the structure Header_msg defined by the user in the IDL file.
     * @ingroup HEADER_MSG
     */
    class Header_msg
    {
    public:
         ...
         */
        eProsima_user_DllExport Header_msg();
         ...
         * @param x Reference to the object idl_msg::Header_msg that will be copied.
         */
        eProsima_user_DllExport Header_msg(
                const Header_msg& x);
         ...
         * @param x Reference to the object idl_msg::Header_msg that will be copied.
         */
        eProsima_user_DllExport Header_msg& operator =(
                const Header_msg& x);
         ...
         * @param x idl_msg::Header_msg object to compare.
         */
